...
//        queue.add(stringRequest);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(gkquestions.this, "correct", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(gkquestions.this, "wrong", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
    ...
    private void updateQuestion(){
        ...
        if (mQuestionNumber >= mQuestions.length){
            Intent i = new Intent(gkquestions.this, final_score.class);
            Bundle bundle = new Bundle();
            bundle.putInt("stuff", mScore);
            bundle.putString("typ", "Interview_GK");
            i.putExtras(bundle);
            startActivity(i);
        }
    }
