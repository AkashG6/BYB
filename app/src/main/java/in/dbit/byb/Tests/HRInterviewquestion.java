...
public class HRInterviewquestion extends AppCompatActivity {
...
//        queue.add(stringRequest);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(HRInterviewquestion.this, "correct", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(HRInterviewquestion.this, "wrong", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
    ...
    private void updateQuestion(){
        ...
        if (mQuestionNumber >= mQuestions.length){
            Intent i = new Intent(HRInterviewquestion.this, final_score.class);
            Bundle bundle = new Bundle();
            bundle.putInt("stuff", mScore);
            bundle.putString("typ", "Interview_HR");
            i.putExtras(bundle);
            startActivity(i);
        }
    }
